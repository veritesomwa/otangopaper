...
/**
 * Full-page login screen. Three sign-in paths:
 *   - Email + password (Sign in tab)
 *   - Email + password + name (Create account tab)
 *   - Google (always visible at the bottom)
 *
 * If the same email already exists across both auth paths, the backend
 * merges them into a single user record — see server/userStore.js.
 */
